...
puts ''
puts 'Gerando Clientes/Usuários do sistema(@company.com)'
...
card_method = company.card_methods
                     .create!(name: 'Cartão Vis', tax_charge: '4', tax_max: '5',
                              code:'333', available: true)

card_method = company.card_methods
                     .create!(name: 'Cartão Mast', tax_charge: '6',
                              tax_max: '7', code:'444', available: true)

pix_method = company.pix_methods
                    .create!(name: 'Pix MP', tax_charge: '8', tax_max: '9',
                             code_bank:'777', code_pix: '555', available: true)

pix_method = company.pix_methods
                    .create!(name: 'Pix WóL', tax_charge: '10', tax_max: '11',
                             code_bank:'888', code_pix: '111', available: false)

puts ''
puts 'Gerando Produtos(@company)'
product_ruby = company.products
                      .new(product_name: 'Curso de ruby', product_price: '150')
product_ruby.create_token
product_ruby.save

product_rails = company.products
                      .new(product_name: 'Curso de rails', product_price: '210')
